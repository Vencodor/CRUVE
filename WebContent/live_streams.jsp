...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	<head>
		...
		<title>Curve - All Live Streams</title>
		...
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					...
					<li class="menu--item">
						<a href="live_streams.jsp" class="menu--link active" title="Live Streams">
				...
				<div class="row">
					<div class="col-xl-9 col-lg-8">
						<div class="section3125">
							<h4 class="item_title">모든 유저</h4>
							<div class="la5lo1">
								<div class="row">
<%
	ArrayList<String> list = userDAO.getUserList(20);
...
%>
									<div class="col-md-3">
										<div class="stream_1 mb-30">
											<a href="live_output.jsp" class="stream_bg">
												<img src="<%="./ProfileImages/"+userDAO.getProfileImage(user)%>" alt="">
												<h4><%=userDAO.getUserName(user)%></h4>
<%
	if(userDAO.getUserEmailOpen(user)==true) {
%>
												<p style="font-size: 5px;"><%=userDAO.getUserEmail(user)%></p>
<%
	}
%>
											</a>
							...
							<div class="fcrse_3">
								...
								<div class="live_text">
									...
									<div class="live-content">
										...
										<button class="live_link" onclick="window.location.href = 'add_streaming.jsp';">Get Started</button>
