			...
			<ul>
				...
				<li class="ui dropdown">
					...
					<div class="menu dropdown_ms">
						...
						<a class="vbm_btn" href="instructor_messages.jsp">View All <i class='uil uil-arrow-right'></i></a>
					</div>
				</li>
				<li class="ui dropdown">
					...
					<div class="menu dropdown_mn">
						...
						<a class="vbm_btn" href="instructor_notifications.jsp">View All <i class='uil uil-arrow-right'></i></a>
					</div>
				</li>
				<li class="ui dropdown">
					...
					<div class="menu dropdown_account">
						...
						<a href="instructor_dashboard.jsp" class="item channel_item">Cursus dashboard</a>						
	...
	<nav class="vertical_nav">
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					<li class="menu--item">
						<a href="instructor_dashboard.jsp" class="menu--link" title="Dashboard">
							<i class="uil uil-apps menu--icon"></i>
							<span class="menu--label">Dashboard</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="instructor_courses.jsp" class="menu--link" title="Courses">
							<i class='uil uil-book-alt menu--icon'></i>
							<span class="menu--label">Courses</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="instructor_analyics.jsp" class="menu--link" title="Analyics">
					...
					<li class="menu--item">
						<a href="instructor_messages.jsp" class="menu--link" title="Messages">
							<i class='uil uil-comments menu--icon'></i>
							<span class="menu--label">Messages</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="instructor_notifications.jsp" class="menu--link" title="Notifications">
					...
					<li class="menu--item">
						<a href="instructor_all_reviews.jsp" class="menu--link" title="Reviews">
