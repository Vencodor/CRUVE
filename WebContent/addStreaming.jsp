...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	...
	<head>
		...
		<title>Cursus - Add Live Live</title>
				...
				<ul>
					...
					<li class="menu--item  menu--item__has_sub_menu">
						...
						<ul class="sub_menu">
							...
							<li class="sub_menu--item">
								<a href="http://www.gambolthemes.net/jsp-items/edututs+/Instructor_Dashboard/my_certificates.jsp" class="sub_menu--link">My Certification</a>
							</li>
						</ul>
					</li>
					<li class="menu--item">
