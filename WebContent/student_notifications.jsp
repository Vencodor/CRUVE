		...
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					...
					<li class="menu--item">
						<a href="student_notifications.jsp" class="menu--link active" title="Notifications">
						...
						<div class="all_msg_bg">
							...
							<div class="channel_my item all__noti5">
								<div class="profile_link">
									<img src="images/left-imgs/img-9.jpg" alt="">
									<div class="pd_content">
										<p class="noti__text5"> You buy a new course. <a href="#" class="crse_bl">How to create sidebar menu</a>.</p>
										<span class="nm_time">20 min ago</span>
									</div>							
								</div>							
							</div>
