...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	...
	<head>
		...
		<title>Cursus - Certification Test Result</title>
					...
					<div class="col-lg-12">						
						<div class="title125">						
								...
								<div class="ttl121">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="certification_center.jsp">Certification Center</a></li>
							...
							<div class="titleright">						
								<a href="certification_center.jsp" class="blog_link"><i class="uil uil-angle-double-left"></i>Back to Certification Center</a>
							</div>
						</div>
						<div class="title126">	
							<h2>Result</h2>
						...
						<div class="certi_form rght1528">
							<div class="test_result_bg">
								...
								<div class="result_content">
									...
									<a href="http://gambolthemes.net/html-imgs/certificate.jpg" class="download_btn" download="w3logo" target="_blank">Download Certificate</a>
								</div>
							</div>
						</div>
					</div>			
