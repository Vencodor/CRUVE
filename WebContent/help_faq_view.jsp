...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	...
	<head>
		...
		<title>Cursus - Help FAQ Single View</title>
								...
								<div class="ttl121">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="help.jsp">Selling & Promotion</a></li>
											<li class="breadcrumb-item active" aria-current="page">Pricing & Coupons</li>
										</ol>
									</nav>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-3 col-md-5">
						<div class="fcrse_3 frc123">
							...
							<ul class="allcate15">
								<li><a href="#" class="ct_item"><i class="uil uil-arrow"></i>Payments</a></li>
								<li><a href="#" class="ct_item active"><i class="uil uil-graph-bar"></i>Selling & Promotion</a></li>
