...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	...
	<head>
		...
		<title>Cursus - Help Instructor FAQ</title>
				...
				<div class="row">
					<div class="col-lg-3 col-md-5">
						<div class="fcrse_3 frc123">
							...
							<ul class="allcate15">
								<li><a href="#" class="ct_item active"><i class="uil uil-arrow"></i>Payments</a></li>
								<li><a href="#" class="ct_item"><i class="uil uil-graph-bar"></i>Selling & Promotion</a></li>
								<li><a href="#" class="ct_item"><i class="uil uil-monitor"></i>Quality Standards</a></li>
								<li><a href="#" class="ct_item"><i class="uil uil-ruler"></i>Course Building</a></li>
								<li><a href="#" class="ct_item"><i class="uil uil-chart-line"></i>Course Management</a></li>
								<li><a href="#" class="ct_item"><i class="uil uil-book-open"></i>Trust & Safety</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-9 col-md-7">
						<div class="vew120 frc123">
							<h4>Taxes</h4>
							<ul class="ntt125">
								<li><a href="#" class="vew121">Common Instructor Questions About The W-8BEN</a></li>
								<li><a href="#" class="vew121">Taxes: What do Instructors Need to Submit to Cursus?</a></li>
								<li><a href="#" class="vew121">What Does Cursus do With my Tax Information (i.e. Withholding)?</a></li>
								<li><a href="#" class="vew121">How do I Submit my Tax Forms to Cursus?</a></li>
								<li><a href="#" class="vew121">How Does Cursus Handle VAT / GST?</a></li>
							</ul>
						</div>
						<div class="vew120 mt-50 mb-30">
							<h4>Payments - General</h4>
							<ul class="ntt125">
								<li><a href="#" class="vew121">How do I Earn Revenue From Cursus for Business?</a></li>
								<li><a href="#" class="vew121">How to opt out of Cursus for Business</a></li>
								<li><a href="#" class="vew121">Payoneer FAQ</a></li>
								<li><a href="#" class="vew121">Missing Instructor Payments</a></li>
								<li><a href="#" class="vew121">Instructor Revenue Share</a></li>
								<li><a href="#" class="vew121">Instructor Revenue Report</a></li>
								<li><a href="#" class="vew121">Instructor Payment Overview</a></li>
								<li><a href="#" class="vew121">How do I Opt Into the Affiliate Program?</a></li>
							</ul>
						</div>
					</div>
				</div>
