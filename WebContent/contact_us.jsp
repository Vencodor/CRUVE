					...
					<div class="col-lg-12">						
						<div class="title125">						
							...
							<div class="titleright">						
								<a href="index.jsp" class="blog_link"><i class="uil uil-angle-double-left"></i>Back to Home</a>
							</div>
						</div>
						<div class="title126">	
							<h2>Contact Us</h2>
			...
			<div class="container">
				<div class="row">					
					<div class="col-lg-3 col-md-6">
						<a href="help.jsp" class="contact_link_step">
							<img src="images/help_icon.svg" alt="">
							<h4>Help Center</h4>
						</a>												
					</div>
					<div class="col-lg-3 col-md-6">
						<a href="our_blog.jsp" class="contact_link_step">
							<img src="images/blog_icon.svg" alt="">
							<h4>Blog</h4>
						</a>												
					</div>
					<div class="col-lg-3 col-md-6">
						<a href="career.jsp" class="contact_link_step">
							<img src="images/career_icon.svg" alt="">
							<h4>Careers</h4>
						</a>												
					</div>
					<div class="col-lg-3 col-md-6">
						<a href="coming_soon.jsp" class="contact_link_step">
