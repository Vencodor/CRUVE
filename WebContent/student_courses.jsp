...
<html lang="en" <%if(session.getAttribute("mode")!=null){if((Boolean)session.getAttribute("mode")==true) {%>class=" night-mode"<%}}%>>
	...
	<head>
		...
		<title>Cursus - Purchased Courses</title>
		...
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					...
					<li class="menu--item">
						<a href="student_courses.jsp" class="menu--link active" title="Courses">
					...
					<li class="menu--item">
						<a href="student_credits.jsp" class="menu--link" title="Credits">
								...
								<table class="table ucp-table" id="content-table">
									...
									<tbody>
										<tr>
											...
											<td><a href="#">Zoena Singh</a></td>
											<td><a href="#">Web Development</a></td>
											<td><b class="course_active">Download</b></td>
											<td>$15</td>
											<td>25 March 2020</td>
											<td>
