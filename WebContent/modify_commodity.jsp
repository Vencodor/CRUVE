...
<title>Cursus - Modity Commodity</title>
<!-- Favicon Icon -->
...
<%
	...
	CommodityDTO a = commodityDAO.getWritten(ID);
	
	if(!a.getUserID().equals(userID)) {
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("alert('다른사람의 글은 수정이 불가합니다.');");
		script.println("history.back();");
		script.println("</script>");
		script.close();
	}
...
<div class="left_section menu_left" id="js-menu">
	<div class="left_section">
		<ul>
			...
			<li class="menu--item">
			<a href="modify_commodity.jsp?ID=<%=ID%>" class="menu--link active" title="Create Course">
			<i class='uil uil-edit menu--icon'></i>
...
<div class="wrapper">
	<div class="sa4d25">
		<div class="container">
			<form method="post" action="commodityUpdate.jsp" id="write"
					enctype="multipart/form-data">
					<input type="hidden" value="<%=ID%>" name="writtenID">
					<div class="row">
						<div class="col-lg-12">
							<h2 class="st_title">
								...
								<div id="add-course-tab" class="step-app">
									<ul class="step-steps">
										<li class="active"><a href="#tab_step1"> <span
												class="number"></span> <span class="step-name">글 수정</span>
										</a></li>
										<li><a href="#tab_step2"> <span class="number"></span>
												<span class="step-name">카테고리 수정</span>
										</a></li>
										<li><a href="#tab_step3"> <span class="number"></span>
												<span class="step-name">커버 사진 재등록</span>
										</a></li>
										<li><a href="#tab_step4"> <span class="number"></span>
												<span class="step-name">구매자 필독 수정 & 파일 재등록</span>
										</a></li>
									</ul>
																...
																<div class="ui search focus mt-30 lbel25">
																	...
																	<div class="ui left icon input swdh19">
																		<input class="prompt srch_explore" type="text"
																			...
																			id="main[title]" value="<%=a.getTitle()%>" required>
																...
																<div class="ui search focus mt-30 lbel25">
																	...
																	<div class="ui left icon input swdh19">
																		<input class="prompt srch_explore" type="text"
																			...
																			data-purpose="edit-course-title" maxlength="60"
																			id="sub[title]" value="<%=a.getSubtitle()%>" required>
															...
															<div class="col-lg-12 col-md-12">
																<div class="course_des_textarea mt-30 lbel25">
																	...
																	<div class="course_des_bg">
																		<textarea id="summernote" name="description"><%=a.getDescription()%></textarea>
																	</div>
																</div>
															</div>
																...
																<div class="ui search focus lbel25">
																	<div class="ui left icon input swdh19">
																		<input class="prompt srch_explore" type="text"
																			...
																			id="main[title]" value="<%=a.getPrice()%>" required>
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="panel-body">
														<div class="ui form">
															<div class="grouped fields">										
																<div class="field fltr-radio">
																	<div class="ui radio checkbox">
																		<input type="radio" name="category" value="Other-Other" tabindex="0" class="hidden" check>
																		<label>Other</label>
																	  </div>
																</div>																								
															</div>
									...
									<p class="testtrm145">카테고리 추가를 희망하신다면 <a href="#">피드백</a> 창을 이용해주세요.</p>
															...
															<div class="col-lg-12">
																<div class="view_all_dt">
																	<div class="view_img_left">
																		<div class="view__img">
																			<img src=".\CoverImage\<%=a.getCoverImage()%>"
																				id="preview-image">
																		</div>
																	</div>
										...
										<div class="step-tab-panel step-tab-location" id="tab_step4">
											<div class="tab-from-content">
													<div class="title-icon">
														<h3 class="title">
															<i class="uil uil-info-circle"></i>구매자 필독 & 파일 & 편집 내용
														</h3>
													</div>
													<div class="course__form">
														<div class="general_info10">
															<div class="row">
																<div class="col-lg-12 col-md-12">
																	<div class="course_des_textarea mt-30 lbel25">
																		<label>구매자 필독글*</label>
																		<div class="course_des_bg">
																			<textarea id="summernote-1" name="buyerDescription" required="required"><%=a.getBuyerDescription()%></textarea>
																		</div>
																	</div>
																</div>
															</div>
																					...
																					<div class="input-group">
																						<div class="custom-file">
																							<input type="file" name="file"
																								class="custom-file-input" id="inputGroupFile06"> <label class="custom-file-label"
																...
																<div class="col-lg-12">
																	<div class="view_info10">
																		<div class="row">
																			<div class="col-lg-4">
																				<div class="part_input lbel25">
																					<label>편집 변경사항 타이틀*</label>
																					<div class="ui left icon input swdh19">
																						<input class="prompt srch_explore" type="text"
																							placeholder="무엇이 변경 되었나요?" name="editTitle"
																							data-purpose="edit-course-title" maxlength="32"
																							id="editTitle" required>
																						<div class="badge_num">32</div>
																					</div>
																				</div>
																			</div>
																		</div>
...
<script>
	$(document).ready( function() {
		$('input:radio[value="<%=a.getCategory()%>-<%=a.getSubcategory()%>"]').attr("checked",true);
	});
</script>
<script>
